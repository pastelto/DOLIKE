...
public class AdminBlackInfo {
	...
	private int blackLimit;			// 한 페이지에 보여질 게시글 최대 갯수
	
	public AdminBlackInfo() {
		// TODO Auto-generated constructor stub
	}

	public AdminBlackInfo(int listCount, int currentPage, int startPage, int endPage, int maxPage, int pageLimit,
			int blackLimit) {
		super();
	...
	public String toString() {
		return "AdminBlackInfo [listCount=" + listCount + ", currentPage=" + currentPage + ", startPage=" + startPage
				+ ", endPage=" + endPage + ", maxPage=" + maxPage + ", pageLimit=" + pageLimit + ", blackLimit="
				+ blackLimit + "]";
	}
