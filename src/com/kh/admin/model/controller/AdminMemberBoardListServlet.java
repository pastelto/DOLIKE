...
/**
 * Servlet implementation class AdminMemberBoardListServlet
 */
@WebServlet("/MemberDetail.am")
public class AdminMemberBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMemberBoardListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ---------------- 페이징 처리 -----------------
				...
				if(am != null) {
					...
					RequestDispatcher view = request.getRequestDispatcher("views/admin/adminMemberDetailView.jsp");
					System.out.println("보드 리스트 값 : " + list);
