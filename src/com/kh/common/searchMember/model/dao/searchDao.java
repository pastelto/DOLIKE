...
public class searchDao {
	...
	// 검색한 아이디 관련 리스트
	public ArrayList<Member> selectSearchUserList(Connection conn, String userId, String searchWord, String choice,
			SearchListPageInfo pi) {
	...
	public int getSearchUserListCount(Connection conn, String userId, String searchWord, String choice) {
		...
		try {
			pstmt = conn.prepareStatement(sql);
			/*
			 * pstmt.setString(1, choice); pstmt.setString(2, userId); pstmt.setString(3,
			 * choice); pstmt.setString(4, "%'" + searchWord + "%'");
			 */
	...
	public ArrayList<Member> selectSearchUserList1(Connection conn, String userId, String searchWord, String choice) {
		ArrayList<Member> list = new ArrayList<Member>();

		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = prop.getProperty("getSearchUserList1");

		try {
			pstmt = conn.prepareStatement(sql);
			/*
			 * pstmt.setString(1, choice); pstmt.setString(2, "'%" + searchWord + "%'");
			 * pstmt.setString(2, searchWord); pstmt.setString(3, userId);
			 * pstmt.setString(4, choice);
			 */
		...
		System.out.println("searchList1 dao ? " + list);
		return list;
	}
