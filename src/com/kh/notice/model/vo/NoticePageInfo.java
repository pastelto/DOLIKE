...
public class NoticePageInfo {
	...
	public NoticePageInfo(int listCount, int currentPage, int startPage, int endPage, int maxPage, int pageLimit,
			int noticeLimit) {
		super();
	...
	public String toString() {
		return "NoticePageInfo [listCount=" + listCount + ", currentPage=" + currentPage + ", startPage=" + startPage
