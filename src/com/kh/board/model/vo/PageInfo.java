...
public class PageInfo {
	...
	private int pageLimit;		//한 페이지 하단에 보여질 페이지 최대의 갯수 
	...
	public PageInfo(int listCount,int currentPage,int startPage,int endPage,int maxPage,int pageLimit,int boardLimit) {
		super();
