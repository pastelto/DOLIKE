<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.ArrayList, com.kh.follow.model.vo.*, com.kh.notice.model.vo.*"%> 
<%
							...
							<div class="card-body" style="margin: 0 auto;">
								...
								<div>
									<table class="table table-hover table-borderless" style="text-align: center;">
										<% System.out.println("여기는 출력이 되는가"); %>
										<% if(list.isEmpty()){ %>
										<% System.out.println("두번째 출력이 되는가"); %>
											<tr>
		...
		function searchId(){
			...
			$.ajax({
				...
				success:function(result){
					if(result == "success"){
						confirm(followId.val()+"님을 친구 추가하겠습니까?");
