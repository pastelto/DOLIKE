                      ...
                      <div class="card" >
                          <div class="card-body">
                              <div class="email-left-box"  style="height: 40rem" ><a href="<%= request.getContextPath() %>/writeForm.ms" id="sendMsgLink" class="btn btn-primary btn-block" style="background: #78c2ad;">쪽지보내기</a>
                                  <div class="mail-list mt-4"><a href="<%= request.getContextPath() %>/list.ms" class="list-group-item border-0 text-primary p-r-0" id="recvMenu"><i class="fa fa-inbox font-18 align-middle mr-2"></i> <b>받은 쪽지함</b>
                                  <%if(newMsgCount > 0){ %>
                              ...
                              <div class="email-right-box"  style="height: 40rem">
								...
								<h4> 받은 쪽지 </h4>
                                  ...
                                  <div class="read-content">
                                      ...
                                      <% if(mat != null) { %>
                                      		<img src="<%=contextPath%>/resources/message_upfiles/<%=mat.getMatNewName()%>" class="Thum"  style="width: 250px; height: 250px;" >
                                      <% } %>
                                      </div>
                                      </div>
                                      <hr>
