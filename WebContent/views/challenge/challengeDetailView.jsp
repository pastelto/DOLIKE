					...
					<div class="media media-reply">
						...
						<div class="media-body">
							<div class="d-sm-flex justify-content-between mb-2">
								<%if(rpList.isEmpty()) {%>
								<h5 class="mb-sm-0">댓글이 없습니다. 댓글을 작성해주세요.</h5>
								<%} else {%>
								<%for(int i=0; i < rpList.size(); i++) {%>
								<h5 class="mb-sm-0">
									<%=rpList.get(i).getRpWriter()%><small class="text-muted ml-3"><%=rpList.get(i).getWriteDate()%></small>
								</h5>
