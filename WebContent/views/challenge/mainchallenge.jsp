			...
			<%if(!list.isEmpty()) {%>
								...
								<div class="bootstrap-carousel" style="height: 5rem;">
									<div id="carouselExampleIndicators" class="carousel slide"
										...
										<div class="carousel-inner">
											<div class="carousel-item active" id="apBanner">
											<%if(loginUser != null) {%>
				...
				<div>
					<ul class="pagination justify-content-center">
						<!-- 맨앞으로 -->
						<li><a id="pageTag" class="page-link" href="<%=contextPath%>/challengeMain.ch?currentPage=1"> &laquo; </a></li>
						
						<!-- 이전페이지 -->
						<% if(currentPage == 1) {%>
						<li class="page-item disabled"><a id="pageDisable" class="page-link"> &lt; </a></li>
						<% }else{ %>
						<li class="page-item"><a id="pageTag" class="page-link" href="<%= contextPath %>/challengeMain.ch?currentPage=<%= currentPage-1 %>"> &lt; </a></li>
						<%} %>
						...
						<%for(int p=startPage; p<=endPage; p++){ %>
							...
							<%}else{ %>
								<li class="page-item"><a id="pageTag" class="page-link" href="<%=contextPath %>/challengeMain.ch?currentPage=<%= p %>"><%= p %> </a></li>
							<%} %>
						...
						<!-- 맨뒤로 -->
						<li><a id="pageTag" class="page-link" href="<%= contextPath %>/challengeMain.ch?currentPage=<%= maxPage %>"> &raquo; </a></li>
					</ul>
				</div>
			</div>
		</div>
