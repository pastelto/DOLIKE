...
<head>
	...
	<title>DO LIKE - 비밀번호찾기</title>
	<style>
	#findUserPwdBtn {
		color: #fff;
	}
	
	#findUserPwdBtn:hover {
		color: #fff;
			                    ...
			                    <div class="form-input-content">
			                        <div class="card login-form mb-0 mt-5">
			                            <div class="card-body pt-5">
			                                <a class="text-center"> <h2>비밀번호찾기</h2></a>
			                                <form id="findForm" class="mt-5 mb-5 login-input" action="<%= request.getContextPath() %>/findPwd.me" method="post" onsubmit="return findPwdValidate();">
			                                    ...
			                                    <button id="findUserPwdBtn" class="btn login-form__btn submit w-100" type="submit">비밀번호찾기</button>
			                                </form>
			                            </div>
			                        </div>
			                    </div>
