		    ...
		    <div class="row page-titles mx-0">
		    	<div class="col p-md-0">
		            <ol class="breadcrumb">
		                ...
		                <li class="breadcrumb-item active">비밀번호찾기 결과</li>
		            </ol>
		        </div>
		    </div>
			                    ...
			                    <div class="form-input-content">
			                        <div class="card login-form mb-0 mt-3">
			                            <div class="card-body pt-5">
			                                <a class="text-center"> <h2>비밀번호 찾기 결과</h2></a>
			                                <form class="mt-5 mb-5 login-input" action="<%= request.getContextPath() %>/loginForm.me" method="post">
			                                    <div class="form-group">
			                                        <input class="form-control" type="text" value="<%= userPwd %>" style="text-align: center;" readonly>
			                                    </div>
