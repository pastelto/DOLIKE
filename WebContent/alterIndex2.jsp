...
<%-- 			<div class="row" style="margin-bottom: 13%;"> 
	...
	<%-- <div class="row">
		<div class="container-fluid">
			...
			<div class="col-12">
				<div class="row">
					<div class="col-6" style="width: 10%; padding-right: 30px; padding-left: 30px;">
						<div class="card">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="text-center">
										...
										<div class="card-footer border-0 bg-transparent">
											<div class="row">
												<div class="col-6 border-right-1">
													...
													<p id="<%=i%>fl"><%= topList.get(i).getBoardTitle() %></p>
												</span>
											</div>
											<div class="col-6">
									...
									<% if(loginUser == null){%>
						 				<button id="disBtn" type="button" class="btn btn-sm btn-rounded" disabled="disabled"><b>닉네임 : <b><%= topList.get(i).getNickName() %> <b>/</b> 조회수 : <%= topList.get(i).getViews() %></button>
						 			<%}else{%>
						 				<form action="insert.fl" method="get">
											<input id="insertFl" type="hidden" name="followId" value="">
											<button id="addfr" type="submit" class="btn btn-sm btn-rounded"><b>닉네임 : <b><%= topList.get(i).getNickName() %> <b>/</b> 조회수 : <%= topList.get(i).getViews() %></button>
										</form>
